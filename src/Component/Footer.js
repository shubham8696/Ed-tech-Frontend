...
const Footer = () => {
    return (
        <footer className="footer mt-5" style={{ background: '#6674cc', color: '#fff', fontFamily: 'Arial, sans-serif', paddingTop: '20px' }}>
            <Container>
                <Row>
                    {/* Logo Column */}
                    ...
                    <Col md={3}>
                        ...
                        <ul style={{ listStyle: 'none', padding: 0 }}>
                            ...
                            <li><Link to="/job-assurance" style={{ textDecoration: 'none', color: '#fff' }}>Job Assurance</Link></li>
                            <li><Link to="/experience-portal" style={{ textDecoration: 'none', color: '#fff' }}>Experience Portal</Link></li>
                            <li><Link to="/become-an-affiliate" style={{ textDecoration: 'none', color: '#fff' }}>Become an Affiliate</Link></li>
                        </ul>
                    </Col>
                    {/* Follow Us Column */}
